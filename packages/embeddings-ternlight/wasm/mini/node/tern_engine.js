...
exports.config_summary = config_summary;
...
function embed(text) {
    ...
    const ret = wasm.embed(ptr0, len0);
...
const wasmPath = `${__dirname}/../tern_engine_bg.wasm`;
